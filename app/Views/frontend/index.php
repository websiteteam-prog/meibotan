  ...
  <style>
   ...
   ========================================= */
    ...
    .welcome-visual .blob {
      position: absolute;
      border-radius: 50%;
      background: radial-gradient(circle, rgba(20, 184, 166, .28), rgba(20, 184, 166, 0));
    }
...
<body>
  ...
  <div id="customBannerSlider" class="carousel slide carousel-fade custom-banner-slider" data-bs-ride="carousel"
    ...
    <div class="carousel-inner">
      <div class="carousel-item active custom-carousel-item">
        <img src="<?php echo base_url(); ?>/assets/frontend/images/hero-banner1.png"
          class="d-none d-md-block w-100 custom-banner-image" alt="Slide 1">
        <img src="<?php echo base_url(); ?>/assets/frontend/images/hero-banner1-mobile.png"
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 text-center mt-5 mt-lg-0">
            <div class="welcome-visual">
              ...
              <img src="<?php echo base_url(); ?>/assets/frontend/images/about.png" alt="Meibotan Probiotics"
      ...
      <div class="row align-items-center dose-grid">
        ...
        <div class="col-lg-4 order-1 order-lg-2 text-center">
          <div class="dose-visual">
            ...
            <img src="<?php echo base_url(); ?>/assets/frontend/images/home-ctafront.webp" alt="Meibotan Product"
              class="dose-product">
          </div>
        </div>
  ...
  <section class="brand-trust-section">
    <div class="container">
      <div class="brand-trust-eyebrow"><i class="fas fa-leaf"></i><span>Certified Excellence</span></div>
  ...
  <script>
    ...
    const tMaxIndex = tTotalItems - tItemsPerView;
    ...
    window.addEventListener('resize', () => {
      tItemsPerView = window.innerWidth < 768 ? 1 : 3;
      updateTestimonialSlider();
    });
