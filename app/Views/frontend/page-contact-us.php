...
<head>
  ...
  <style type="text/css">
    ...
    /* =========================================
       PAGE HERO (text banner, no photo)
       ========================================= */
    .page-hero {
  ...
  <div class="page-wrapper">
    ...
    <main class="main">
      <section class="page-hero">
        <div class="container">
          <span class="page-hero-badge"><i class="fas fa-leaf"></i> Get In Touch</span>
          <h1 class="page-hero-title">Contact <span>Us</span></h1>
          <div class="page-hero-breadcrumb">
            <a href="<?php echo base_url(); ?>">Home</a> <i class="fas fa-chevron-right"></i> <span>Contact Us</span>
          </div>
        </div>
      </section>
                ...
                <div class="office_location">
                  ...
                  <div>
                    ...
                    <p><span>Call:</span> +91-7009057196<br />
                      <span>Email:</span> support@meibotan.com
                    </p>
          ...
          <p>New Cut Rd, St Davids, Swansea SA1 2DN</p>
            ...
            <div class="col-lg-6">
              <div class="contact-form-card">
                ...
                <p class="form-note">Got any problems with purchase? Wanna ask for a piece of advice or leave a
                  suggestion? Don't hesitate and write to our Email!</p>
                <?php
